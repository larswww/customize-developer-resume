...
function WorkflowStepItem({ step, stepData, index }: WorkflowStepItemProps) {
		...
		if (
			...
			return (
				<div className="p-2 rounded bg-green-50">
					<div className="markdown-content prose max-w-none overflow-auto max-h-[500px]">
						{isResultString ? (
	...
	return (
		<div className="mb-4">
			<div className="p-4 rounded-lg">{titleContent}</div>
...
export function WorkflowSteps({
	...
	return (
		<div className={`mb-8 ${height}`}>
			<Collapsible title={titleContent} defaultOpen={false} className="mb-4">
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					{stepsToRender.map((step, index) => (
						<WorkflowStepItem
							...
							step={step}
							index={index}
							stepData={workflowStepsData.find(
