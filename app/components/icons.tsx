...
const LoadingSpinnerBase: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
	<svg
		...
		fill="none"
		viewBox="0 0 24 24"
		className={`animate-spin -ml-1 mr-3 text-[var(--color-yellow-500)] ${props.className || ""}`}
		aria-hidden="true"
	>
		<title>Loading</title>
		<circle
			className="opacity-25 stroke-[var(--color-yellow-200)]"
			cx="12"
			cy="12"
			r="10"
			stroke="currentColor"
		...
		/>
		<path
			className="opacity-75 fill-[var(--color-yellow-500)]"
			fill="currentColor"
...
const FailedIconBase: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 20 20"
		fill="currentColor"
