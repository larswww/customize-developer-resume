...
import { Form, Outlet, useNavigation, useOutletContext } from "react-router";
...
import { handleContentAction } from "~/routes/resume/utils";
...
export default function JobContent({ actionData }: Route.ComponentProps) {
